...
?>
  <h2 class="quizHeader">Take a Quiz!</h2>
		...
		<input class="answer" type="radio" name="q1" value="0" id="q1a1">
		...
		<br>
		<input class="answer" type="radio" name="q1" value="1" id="q1a3">
		...
		<br>
		<input class="answer" type="radio" name="q2" value="0" id="q2a2">
		<label for="q2a2">It tells the computer to wait 4 seconds before sending ping packets.</label>
		<br>
		<input class="answer" type="radio" name="q2" value="1" id="q2a3">
		...
		<br>
		<input class="answer" type="radio" name="q3" value="0" id="q3a2">
		<label for="q3a2">When they want to check the disk usage of a specific folder.</label>
		<br>
		<input class="answer" type="radio" name="q3" value="1" id="q3a3">
		...
		<input class="answer" type="radio" name="q4" value="1" id="q4a1">
		<label id="correctString4" for="q4a1">List the users logged in to a particular computer.</label>
		<br>
		<input class="answer" type="radio" name="q4" value="0" id="q4a2">
		...
		<input class="answer" type="radio" name="q6" value="0" id="q6a1">
		...
		<br>
		<input class="answer" type="radio" name="q6" value="1" id="q6a3">
